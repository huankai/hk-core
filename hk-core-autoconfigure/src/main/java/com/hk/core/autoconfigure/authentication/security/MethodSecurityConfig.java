...
public class MethodSecurityConfig extends GlobalMethodSecurityConfiguration {
        ...
        return new PermissionEvaluator() {
            ...
            public boolean hasPermission(Authentication authentication, Object targetDomainObject, Object permission) {
                ...
                return principal.isAdministrator()
                        || principal.isProtect()
                        || principal.getPermissionByAppId(AppCodeUtils.getCurrentAppId()).contains(String.valueOf(permission));
            }
    ...
    protected static class ProtectedSecurityExpressionRoot implements SecurityExpressionOperations {
        ...
        public boolean hasAnyAuthority(String... authorities) {
            ...
            return principal.isAdministrator()
                    || principal.isProtect()
                    || principal.getPermissionByAppId(AppCodeUtils.getCurrentAppId()).containsAll(Arrays.asList(authorities))
        ...
        public final boolean hasAnyRole(String... roles) {
            ...
            return principal.isAdministrator()
                    || principal.isProtect()
                    || principal.getRoleByAppId(AppCodeUtils.getCurrentAppId()).containsAll(Arrays.asList(roles))
